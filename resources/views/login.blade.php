    ...
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          ...
          <form method="POST" action="{{route('valida_login')}}">
              <h1><strong>IUMEC </strong>Login</h1>
              <div>
                  {{ csrf_field() }}
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Administracion IUMEC</h1>
                  <p>©2019 esta plataforma hace parte de la administracion de la iglesia IUMEC</p>
                </div>
              </div>
            </form>
          </section>
